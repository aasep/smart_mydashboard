                                    ...
                                    <div class="alert alert-success display-hide">
                                        <button class="close" data-close="alert"></button> Your form validation is successful! </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <select class="form-control select2" name="group_user">
...
<!--  end delete modal -->
                    ...
                    <div class="page-content-container">
                        ...
                        <div class="portlet-body form">
                            ...
                            <?php
                            $i=1;
                            $query =" select a.iduser,a.username,a.nama_lengkap,b.groupid,a.status,b.groupname,a.email,a.adddt from smart_user_account a ";
                            $query.=" left join smart_group_user b on a.groupid=b.groupid ";
                            //echo $query;
                            ...
                            //$nik= isset($RS2->fields['nik']) ? $RS2->fields['nik'] : " - ";
                            echo "<tr>";
                            echo "<td>$i</td>";
                            echo "<td><b> <i class='fa fa-user'></i> ".$RS2->fields['username']."</b></td>";
                            echo "<td>".$RS2->fields['nama_lengkap']."</td>";
                            echo "<td>".$RS2->fields['groupname']."</td>";
                            echo "<td>$status</td>";
                            echo "<td>".$RS2->fields['email']."</td>";
                            echo "<td>".date('d-m-Y H:i',strtotime($RS2->fields['adddt']))."</td>";
                            echo "<td><a class='detailEdit' data-toggle='modal' data-target='#view-edit' href='#' id-username='".$RS2->fields['username']."'   id-namalengkap='".$RS2->fields['nama_lengkap']."' 
id-group='".$RS2->fields['groupid']."'  id-namagroup='".trim($RS2->fields['groupname'])."' id-email='".trim($RS2->fields['email'])."' id-nim='".trim($RS2->fields['nik'])."' id-status_account='".$RS2->fields['status']."' ><button class='btn default'>Edit</button></a></a> <a href='#'  data-toggle='modal' id-username='".$RS2->fields['username']."' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
                            echo "</tr>";
                            $i++;
                            $RS2->MoveNext();
                                    }
